...
const { createCommunity, getCommunities, getCommunity, joinCommunity, getPostsByCommunity, getPermission, leaveCommunity, deleteCommunity, editCommunity, memberToApprove } = require('../controllers/community')
const { createPost, getPosts, getPost, deletePost, editPost, getPostsGuest, postToApprove } = require('../controllers/post')
...
router.get('/community/memberToApprove/:id', memberToApprove)
...
router.get('/postToApprove/:id', postToApprove)
