...
const { createPost, getPosts, getPost, deletePost, editPost, getPostsGuest, postsToApprove } = require('../controllers/post')
...
router.get('/community/membersToApprove/:id', memberToApprove)
